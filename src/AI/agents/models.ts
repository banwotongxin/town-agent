 ...
 * 赛博小镇 - 智能体模型定义
 * 
 * 这个文件定义了角色的基本数据结构和默认配置。
 * 就像是一个人事档案系统，记录了每个角色的：
 * - 基本信息（名字、年龄、职业）
 * - 性格特点
 * - 背景故事
 * - 兴趣爱好
 ...
 * 
 * 主要包含：
 * 1. Profession枚举 - 定义8种职业类型
 * 2. AgentProfile接口和类 - 角色档案的数据结构
 * 3. DEFAULT_PROFILES - 8个默认角色的预设配置
 * 4. createAgentProfile函数 - 创建新角色的工厂函数
 */

/**
 * 职业枚举，定义了智能体的职业类型
 * 
 * 枚举是一种特殊的类型，限定了只能取特定的几个值。
 * 这里定义了8种职业，就像是8种不同的身份标签。
 * 每个职业都有对应的中文名称。
 */
export enum Profession {
  WRITER = "作家",      // 作家 - 擅长写作和创作
  DOCTOR = "医生",      // 医生 - 擅长医疗和健康咨询
  PROGRAMMER = "程序员",  // 程序员 - 擅长编程和技术问题
  TEACHER = "教师",      // 教师 - 擅长教学和知识传授
  ARTIST = "艺术家",     // 艺术家 - 擅长艺术创作和审美
  ENGINEER = "工程师",    // 工程师 - 擅长工程和技术设计
  SCIENTIST = "科学家",   // 科学家 - 擅长科学研究和数据分析
  BUSINESS = "商人"       // 商人 - 擅长商业分析和谈判
}
